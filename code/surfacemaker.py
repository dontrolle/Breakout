...
class SurfaceMaker:
  ...
  def get_surf(self,block_type,size):
    ...
    # left side
    left_height = int(size[1] - (sides['topleft'].get_height() + sides['bottomleft'].get_height()))
    ...
    # right side
    right_height = int(size[1] - (sides['topright'].get_height() + sides['bottomright'].get_height()))
    ...
    # bottom side
    bottom_width = int(size[0] - (sides['bottomleft'].get_width() + sides['bottomright'].get_width()))
    ...
    # center color
    center_height = int(size[1] - (sides['top'].get_height() + sides['bottom'].get_height()))
    center_width = int(size[0] - (sides['right'].get_width() + sides['left'].get_width()))
